...
A campaign to add a constitutional amendment banning congressional stock
trading via an Article V constitutional convention — bypassing Congress, which
has a structural conflict of interest in regulating itself.
...
| [operations.md](operations.md) | Coalition structure, candidate organizations, funding, state operations, timeline |
...
That is the campaign. Everything else is execution.
